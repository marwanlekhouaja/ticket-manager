...
<footer style="background-color: #eee" class="p-2">
    <h3 style="font-family: monospace" class="text-center mt-3">Suivez-nous sur les réseaux sociaux</h3>
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div>
            <a href="https://www.redal.ma/fr/contactez-nous-0" style="font-family: monospace" class="text-dark text-decoration-none">Contactez-nous</a>
            <a href="https://www.redal.ma/fr/actualites" style="font-family: monospace" class="text-dark ms-3 text-decoration-none">Actualité</a>
        </div>
